...
public class ExpandTabView extends LinearLayout {
    ...
    private void initLayout() {
        ...
        LinearLayout.LayoutParams tabViewParams = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);
    ...
    abstract static class Adapter {
        ...
        abstract View getTabView(int position, ViewGroup parentView);

        abstract String getTabViewDes(int position);

        abstract View getMenuContentView(int position, ViewGroup parentView);

        abstract void openMenu(int position, View tabView);

        abstract void closeMenu(int position, View tabView);
    }
}
